...
-- ----------------------------
INSERT INTO `t_answers` VALUES (1, 1, 1, 0, 0, 'Привіт. Зараз як ніколи треба діяти злагоджено. Тільки так ми подолаємо ворога.\r\n\r\nДопоможіть нашій армії – повідомляйте адресу пересування військової техніки та військ окупантів. Вони допоможуть Штабу Збройних Сил України завдати гідну відсіч супротивнику ✊', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (2, 1, 2, 0, 0, '🇺🇦 Для підтвердження особистості пройдіть авторизацію через застосунок Дія.\r\n\r\n☝️ Попередньо потрібно оновити застосунок Дія до останньої версії.\r\n\r\n✅ Натискайте кнопку авторизації тільки у мобільному застосунку Telegram.\r\n\r\nℹ️ Якщо протягом 30 секунд ви не авторизувались через Дію, то потрібно згенерувати нове посилання.\r\n\r\nТисніть /start, щоб згенерувати нове посилання.', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (3, 1, 3, 1, 1, '🚛 Якщо ви побачили техніку чи окупантів, фотографуйте або знімайте на відео, долучайте геолокацію, щоб ми оперативно передали до ЗСУ.\r\n\r\n🇷🇺 Якщо ви дізналися, про колаборантів, які допомагають ворогу та відкрито виступають проти держави, повідомляйте нам.\r\n\r\n🧨 Якщо натрапили на вибухонебезпечні та підозрілі предмети, повідомляйте про них Державній службі з надзвичайних ситуацій.\r\n\r\n🩸 Проте якщо ви в Бучі, Ірпені чи Гостомелі, бачили російських військових, маєте їх фотографії або відео, подробиці про їх вчинки або вбивства – відправляйте нам.\r\n  \r\n🕹 Будь ласка, оберіть кнопками, про що саме ви б хотіли повідомити?', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (6, 1, 3, 15, 1, '👀 Звідки ви дізналися про ворога? Вкажіть, будь ласка, джерело даних\r\n\r\n❕ Нам дуже важливо знати, звідки надходить інформація', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (7, 1, 3, -1, -1, '❓ Ви бачили техніку, скупчення окупантів, російських солдатів в Київській області чи хотіли б повідомити про колаборантів?', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (8, 1, 3, 6, 1, '🏠 Оберіть, будь ласка, місто, в якому ви бачили російських солдатів', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (9, 1, 3, 21, 1, '📸 Надішліть фото або відео облич російських солдатів', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (10, 1, 4, 21, 1, 'Як це зробити?', 'https://test-chat1.ds1.net.ua/video/PHOTO_1.mp4', '{\"branch\":23,\"step\":1}', NULL);
INSERT INTO `t_answers` VALUES (11, 1, 5, 22, 1, '✍️ Опишіть, що знаєте про цього солдата — ПІБ, військовий підрозділ, його дії в період вторгнення, відношення до оточуючих або вбивства мирних жителів\r\n\r\n☝️ Подробиці допоможуть знайти цих нелюдів', NULL, '{\"branch\":24,\"step\":1}', NULL);
INSERT INTO `t_answers` VALUES (12, 1, 3, 23, 1, '☝️Якщо завантажили всі файли, то тисніть ➡️ Далі', NULL, NULL, NULL);
INSERT INTO `t_answers` VALUES (13, 1, 6, 24, 1, '🙌 Дякуємо! Ваші дані дозволять знайти та покарати загарбників.', NULL, '{\"branch\":-1,\"step\":-1}', 1);
...
-- ----------------------------
-- Table structure for t_bots
-- ----------------------------
DROP TABLE IF EXISTS `t_bots`;
CREATE TABLE `t_bots`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- Records of t_bots
-- ----------------------------
INSERT INTO `t_bots` VALUES (1, '5721687279:AAGu6IiZilunOAoC0Y0kzDPkkJGLNXmCai0', 'testDs1_bot');
...
-- ----------------------------
-- Table structure for t_comands
-- ----------------------------
DROP TABLE IF EXISTS `t_comands`;
CREATE TABLE `t_comands`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `bot_id` int(10) NULL DEFAULT NULL,
  `comand` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of t_comands
-- ----------------------------
INSERT INTO `t_comands` VALUES (1, 1, '/start');
